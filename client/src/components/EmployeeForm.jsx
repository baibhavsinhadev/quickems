    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6 max-w-3xl animate-fade-in">
            ...
            <div className="card p-5 sm:p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700">
                    <div>
                        <label className="block mb-2">Dapartment</label>
                    ...
                    <div>
                        ...
                        <input type="number" name="basicSalary" min={0} required defaultValue={initialData?.basicSalary || "0"} />
                    </div>

                    <div>
                        <label className="block mb-2">Allowances</label>
                        <input type="number" name="allowances" min={0} required defaultValue={initialData?.allowances || "0"} />
                    </div>

                    <div>
                        <label className="block mb-2">Deductions</label>
                        <input type="number" name="deductions" min={0} required defaultValue={initialData?.deductions || "0"} />
                    </div>
            ...
            <div className="flex flex-col-reverse card sm:flex-row justify-end gap-3 p-3">
                <button onClick={() => onCancel ? onCancel() : navigate(-1)} type="button" className="btn-secondary cursor-pointer hover:scale-105 active:scale-95">Cancel</button>

                <button type="submit" disabled={loading} className="btn-primary flex items-center justify-center cursor-pointer hover:scale-105 active:scale-95 disabled:cursor-not-allowed disabled:opacity-20">
