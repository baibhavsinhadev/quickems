import { ArrowRightIcon, Building2Icon, CalendarIcon, FileTextIcon, UsersIcon } from "lucide-react";
        ...
        <div className="animate-fade-in">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 mb-8">
                {stats.map((stat, index) => {
                    ...
                    return (
                        <div className="card card-hover p-5 sm:p-6 relative overflow-hidden group flex items-center justify-between cursor-pointer">
                            <div>
